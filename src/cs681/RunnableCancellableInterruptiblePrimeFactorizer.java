...
public class RunnableCancellableInterruptiblePrimeFactorizer extends RunnableCancellablePrimeFactorizer {
	...
	public static void main(String[] args) {
		// RunnableCancellableInterruptiblePrimeFactorizer gen = new RunnableCancellableInterruptiblePrimeFactorizer(1,100);
		...
		LinkedList<RunnableCancellableInterruptiblePrimeFactorizer> runnables = new LinkedList<RunnableCancellableInterruptiblePrimeFactorizer>();
